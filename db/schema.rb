...
ActiveRecord::Schema.define(version: 20140702235652) do
  ...
  add_index "circle_memberships", ["friend_id", "circle_id"], name: "index_circle_memberships_on_friend_id_and_circle_id", unique: true
